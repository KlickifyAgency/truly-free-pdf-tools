      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Free PDF tools cap file sizes because they're paying for server bandwidth and memory. Every large file you upload costs them money. So they limit you. Smallpdf's free tier caps uploads at 5MB. iLovePDF allows up to 100MB but restricts to two operations per day.</p>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>For truly massive files — scanned archives, high-res design portfolios, 500-page merged reports — use Chrome or Edge on a desktop. Mobile browsers have less RAM to work with. Mobile browsers have more constrained memory and may struggle with files above 100MB.</p>
        </div>
