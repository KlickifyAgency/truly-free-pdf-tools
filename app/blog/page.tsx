...
const posts = [
  { slug: "how-smallpdf-limits-free-users-and-what-to-use-instead", title: "How Smallpdf limits free users and what to use instead", description: "Discover the hidden limits Smallpdf places on free accounts and learn free alternatives you can use right now.", date: "September 18, 2026", readTime: "9 min read", lang: "EN", category: "HOW-TO GUIDE", categoryColor: "#16a34a", categoryBg: "#f0fdf4" },
  ...
  { slug: "smallpdf-alternatives", title: "Smallpdf Alternatives That Are Actually Free in 2026", description: "Hit the Smallpdf 2-task daily limit? These alternatives have no daily caps, no watermarks, and some never upload your file to any server.", date: "June 9, 2026", readTime: "10 min read", lang: "EN", category: "COMPARISON", categoryColor: "#0058c3", categoryBg: "#eff6ff" },
  { slug: "adobe-acrobat-alternative-free", title: "Adobe Acrobat Alternative — Free PDF Editor for 2026", description: "Adobe Acrobat Pro costs $239.88 a year. These free alternatives handle compression, merging, splitting, and password removal with no subscription and no file size limits.", date: "June 9, 2026", readTime: "9 min read", lang: "EN", category: "COMPARISON", categoryColor: "#0058c3", categoryBg: "#eff6ff" },
  ...
  { slug: "how-to-convert-powerpoint-to-pdf-for-free", title: "How to Convert PowerPoint to PDF for Free", description: "Learn how to convert PowerPoint to PDF for free using online tools and avoid expensive software.", date: "July 24, 2026", readTime: "15 minutes", lang: "EN", category: "Productivity", categoryColor: "#4CAF50", categoryBg: "#F7F7F7" },
  { slug: "how-to-convert-excel-to-pdf-with-formatting-intact", title: "How to Convert Excel to PDF with Formatting Intact", description: "Learn how to convert Excel files to PDF while preserving the original formatting, including step-by-step instructions and comparisons with top tools.", date: "July 31, 2026", readTime: "10 minutes", lang: "EN", category: "Productivity", categoryColor: "#4CAF50", categoryBg: "#F7F7F7" },
  { slug: "how-to-edit-a-pdf-without-converting-it-to-word", title: "How to edit a PDF without converting it to Word", description: "Learn how to edit PDFs directly without converting them to Word, using the best online tools and software.", date: "August 7, 2026", readTime: "15 minutes", lang: "EN", category: "PDF", categoryColor: "#FF9900", categoryBg: "#FFD7AC" },
  { slug: "pdf-accessibility-how-to-make-pdfs-readable-by-screen-reader", title: "PDF Accessibility: How to Make PDFs Readable by Screen Readers", description: "Learn practical step-by-step techniques to create PDF files that work flawlessly with screen readers. Includes tools, best practices, and FAQs.", date: "August 29, 2026", readTime: "9 min", lang: "EN", category: "Accessibility", categoryColor: "#1A73E8", categoryBg: "#eff6ff" },
  { slug: "how-to-batch-compress-multiple-pdfs-at-once", title: "How to Batch Compress Multiple PDFs at Once", description: "Compress a whole folder of PDFs in one pass using free online tools, desktop apps, and command-line scripts.", date: "September 4, 2026", readTime: "8 min", lang: "EN", category: "HOW-TO GUIDE", categoryColor: "#16a34a", categoryBg: "#f0fdf4" },
];
