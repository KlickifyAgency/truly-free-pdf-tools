  ...
  return (
    <>
      ...
      >
        ...
        <p>Honest answer: I run ads on the homepage and blog pages. That is it. Google AdSense pays me a small amount every time someone sees those ads. Not when you compress a file — that would be annoying. Just when you land on the site or read an article. The money covers hosting, domain renewal, and coffee. I do not make a profit. I built this because the PDF tool space is full of greed and I wanted one honest corner of the internet.</p>
        ...
        <p>No, you need to remove the password first. Use our PDF Password Remover tool (also free, also local). Once the PDF is unlocked, you can compress it. The compressor cannot read encrypted files because they are scrambled. This is a security feature, not a bug. If the tool could read password-protected PDFs without the password, that would be a security vulnerability.</p>
