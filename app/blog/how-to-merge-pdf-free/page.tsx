...
export default function HowToMergePdfFreePage() {
  const articleSchema = {
  ...
  return (
    <>
      ...
      >
        ...
        <p>Sejda does not require an email, I will give them credit. But their free tier limits you to three tasks per hour and 50 pages per merge. Merge two 30-page PDFs? That is 60 pages. Sejda rejects it. PDF24 is genuinely free and does not require email, but again, it is desktop software. You have to install it.</p>
