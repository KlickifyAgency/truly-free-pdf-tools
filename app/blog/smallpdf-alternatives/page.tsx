...
export default function SmallpdfAlternativesPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      { "@type": "Question", name: "Is Truly Free PDF Tools really 100% free with no limits?", acceptedAnswer: { "@type": "Answer", text: "Yes. No daily task limits, no file size limits (beyond what your browser can handle), no page limits, no watermarks, no pro upgrade button hiding in the corner. I fund the site through display ads on the dashboard and blog pages. You never pay a cent. I have tested the compressor on a 500MB PDF with 1,200 pages. It worked. Slow, but it worked. That is the kind of no-limits you do not get from Smallpdf (2 tasks/day) or Sejda (3 tasks/hour)." } },
      { "@type": "Question", name: "Is it safe to upload sensitive PDFs like tax returns or contracts?", acceptedAnswer: { "@type": "Answer", text: "You are not uploading anything. That is the key difference. The tools run locally in your browser using WebAssembly. Your files never leave your computer. With Smallpdf, iLovePDF, or Adobe's online tools, your file gets copied to their servers. That means their employees could theoretically access it, or hackers could intercept it. With Truly Free PDF Tools, the PDF stays on your hard drive the entire time. I cannot see it. No one can." } },
      { "@type": "Question", name: "Will compressing a PDF make the text blurry or images pixelated?", acceptedAnswer: { "@type": "Answer", text: "It depends on the compression level you choose. Low compression reduces file size by about 20-30% with almost no visible quality loss — great for text-heavy documents. Medium compression (what most people use) reduces by 50-70% and may slightly soften high-resolution images, but text remains sharp. High compression can make images fuzzy if you are printing, but for screen viewing or email attachments, it is usually fine. I recommend testing Medium first, then going lower or higher based on your needs." } },
      { "@type": "Question", name: "Can I use this on my phone or tablet?", acceptedAnswer: { "@type": "Answer", text: "Yes, as long as you have a modern browser (Chrome, Safari, Firefox, Edge). The tools work on iPhones, iPads, Android phones, and Chromebooks. Unlike PDF24 which requires a Windows desktop install, or Adobe Acrobat which needs a paid mobile app for full features, Truly Free PDF Tools runs entirely in your browser. I have used it on an iPhone 12 to compress a PDF before emailing it. Worked perfectly." } },
      { "@type": "Question", name: "How does Truly Free PDF Tools compare to Smallpdf's paid plan?", acceptedAnswer: { "@type": "Answer", text: "Smallpdf charges $108 to $144 per year for unlimited tasks. With that, you get no watermarks, larger file limits (not unlimited — they still cap at 1GB), and access to their full tool suite. Truly Free PDF Tools gives you unlimited tasks, no watermarks, no file size limits beyond browser capability, and five core tools (compressor, merger, splitter, password remover, image-to-PDF). The only thing you lose is their fancy UI animations and the ability to export to Word (which we do not have yet). For 90% of users, the free option wins." } },
  ...
  return (
    <>
      ...
      >
        ...
        <p>What about PDF24? It is genuinely free, I will give them that. But it is desktop software. You download an installer, it adds shortcuts to your start menu, and the interface looks like Windows 98. It works, but you cannot use it on a Chromebook, a library computer, or your phone. Sejda is better designed, but again: three tasks per hour, 50 pages max, 50MB max. Try splitting a 200-page PDF on Sejda. It will laugh at you.</p>
        ...
        <p><strong>1. Go to trulyfreetools.com and click the PDF Compressor tool.</strong> You do not need to register. There is no "Sign Up" button because I did not build one. Just scroll down the homepage or click the Compress PDF link in the navigation. The tool loads instantly because everything runs in your browser — no waiting for a server to spin up.</p>
        ...
        <p><strong>6. Download the compressed PDF.</strong> Click the green download button. The file saves to your computer with "_compressed" added to the filename. That is it. No watermark. No email asking you to confirm your address. No pop-up offering a "pro plan." You can compress another file immediately.</p>
        <p><strong>7. (Optional) Compress multiple files in a row.</strong> There is no cooldown timer. Compress ten PDFs back to back. Compress a hundred. The tool does not care. The only limit is your patience. I have seen freelance graphic designers compress an entire portfolio of 200 PDFs in one sitting.</p>

        <h2>Why Truly Free PDF Tools Is Actually Free</h2>
        <p>Let me be completely honest with you. The site costs money to run — domain registration, hosting for the blog, CDN for the static assets. I do not have a venture capital fund. I pay for this out of pocket because I wanted to build something useful without the usual PDF tool greed. The money comes from display advertising. You will see ads on the homepage, on the tool selection dashboard, and on these blog articles. That is it. No ads appear while you compress a PDF, merge files, or remove a password. I made that decision deliberately. Interrupting you during a task is annoying, and annoying users do not come back.</p>
        ...
        <p>You are not uploading anything. That is the key difference. The tools run locally in your browser using WebAssembly. Your files never leave your computer. With Smallpdf, iLovePDF, or Adobe's online tools, your file gets copied to their servers. That means their employees could theoretically access it, or hackers could intercept it. With Truly Free PDF Tools, the PDF stays on your hard drive the entire time. I cannot see it. No one can.</p>
        ...
        <p>Try the compressor right now. No signup, no watermark, no limit. If you hit a paywall, I will personally fix it.</p>
