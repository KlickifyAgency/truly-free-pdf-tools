  ...
  return (
    <>
      ...
      >
        ...
        <p><strong>5. Convert a PDF to Word (Smallpdf charges after 2 tasks).</strong> Use our <a href="/pdf-to-word">PDF to Word tool</a>. Works on text-based PDFs. No signup, no daily limit.</p>
        <p><strong>6. For other tools (OCR, image-to-PDF conversion, editing).</strong> Smallpdf has tools we do not. For those, use a combination of free desktop software (LibreOffice, PDF24) or accept that some tasks require paid tools. I am honest about our limitations.</p>
        ...
        <p>No. We have five core tools: compressor, merger, splitter, password remover, and PDF-to-Word converter. Smallpdf has over 20 tools including OCR and e-signatures. For the tools we have, we are better (unlimited, no watermark). For tools we lack, you need another solution.</p>
