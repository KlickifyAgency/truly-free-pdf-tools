      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Smallpdf started free in 2013. By 2019, they'd put up a paywall — two operations per day, then you're cut off. iLovePDF did the same. Adobe Acrobat Online is essentially a subscription funnel from the first click. The pattern is the same every time: build habit, then monetize.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>TrulyFreeTools is built on a different model. All PDF processing runs in your browser using WebAssembly — there is no server infrastructure to operate, no per-request compute cost, and no bandwidth cost for processing files. Without those costs, there's no reason to charge you.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>The site is monetized through non-intrusive advertising. That revenue covers domain and CDN costs. The tools themselves are permanently free. Not free for 14 days. Not free until you hit a limit. Just free.</p>
        </div>
