      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>When you upload a document to a cloud PDF tool, you are creating a copy of that document on infrastructure you do not control. Most services retain uploaded files for 24 hours or longer. Their privacy policies grant broad permissions to process, analyze, and store file content for service improvement purposes.</p>
