      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            The privacy case against cloud-based PDF processing
          </h2>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Every time you upload a file to a cloud PDF tool, you're creating a copy of that document on a server you've never seen, run by people you don't know. Most services keep your file for at least 24 hours — sometimes longer. Their privacy policies include language that lets them process and analyze file content for 'service improvement.' Read those policies sometime.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>For most documents this is an acceptable trade-off. For documents containing proprietary business information, personal health data, legal strategy, or financial records, the risk calculus is different. Professional and legal contexts often have compliance requirements — HIPAA, GDPR, attorney-client privilege — that are incompatible with uploading files to third-party services.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>TrulyFreeTools processes all PDF operations locally in your browser. No file is transmitted to any server. Processing uses WebAssembly — the same compiled binary runtime that runs native applications in browsers. Your files exist only in local browser memory and are discarded when you close the tab.</p>
        </div>
