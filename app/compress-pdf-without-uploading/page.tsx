      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Picture what actually happens when you use a cloud PDF tool: your file leaves your computer, lands on a server somewhere, gets processed, and comes back. Most people never think about this step. Two problems with that. One: you need internet for something that doesn't require internet. Two: your document exists on someone else's machine, even if just for a minute.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>For most files, that's fine. For a contract, a medical record, a financial statement — it's not fine. Those documents have real stakes attached to them.</p>
