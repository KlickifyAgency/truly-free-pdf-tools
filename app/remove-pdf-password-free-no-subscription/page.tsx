      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181c1e", letterSpacing: "-0.02em", marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Password removal is actually a simple operation: take the decryption key you already know, apply it to the encrypted file, write the output without the encryption layer. It's one step. When you know the password, it takes under a second for most files. There's no heavy computation involved.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>Some tools charge for this because they run it on their servers and need to cover those costs. That's their problem, not yours. TrulyFreeTools processes decryption entirely in your browser using WebAssembly — there is no server, no infrastructure cost, and therefore no economic justification for a subscription.</p>
            <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.7, letterSpacing: "-0.01em", marginBottom: 16 }}>More importantly: if the decryption happens locally, your password never goes anywhere. You're not sending credentials to a stranger's server. Server-based tools receive your file AND your password over the network. Think about that. With local processing, neither is transmitted.</p>
        </div>
